function cd = critical_difference(s,labels,alpha, titleName)
%
% CRITICAL_DIFFERNCE - plot a critical difference diagram
%
%    CRITICAL_DIFFERENCE(S,LABELS) produces a critical difference diagram [1]
